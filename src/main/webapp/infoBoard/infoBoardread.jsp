...
$(function(){
    ...
    $("#btnReply").click(function(){
        ...
        var studyNo="${post.postNo}"; //게시물 번호
        var param={ "replytext": replytext, "postNo": postNo};
...
function listReply(){
    $.ajax({
        ...
        url: "${path}/front?key=postReply&methodName=selectAllReply&postNo=${post.postNo}", //컨트롤러로 보내기.. 게시판 번호도 같이 보낸다.
