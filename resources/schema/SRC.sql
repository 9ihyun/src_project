...
--별점 평가
CREATE TABLE POINT(
    USER_ID VARCHAR2(20) NOT NULL CONSTRAINT POINT_ID_FK REFERENCES MEMBER_USER(USER_ID) ON DELETE SET NULL,
    POINT_NUMBER NUMBER(1) NOT NULL,
    EVALUATOR VARCHAR2(20) NOT NULL CONSTRAINT POINT_EVAL_FK REFERENCES MEMBER_USER(USER_ID) ON DELETE SET NULL
);
